...
library(readxl)
setwd("C:/Users/jensh")
dat <- read_excel("C:/Users/jensh/resultat_dna_analyse.xlsx")
...
# Oppretter data som en tibble
bronner_data <- tibble(
  Brønn = c("Brønn 1", "Brønn 2", "Brønn 3"),
  "Produktstørrelse (bp)" = c("407 bp", "401 bp", "396 bp og 296 bp")
)

# Skriver ut tabellen som en HTML-tabell
knitr::kable(bronner_data, caption = "Produktstørrelser i ulike bronner")
...
#| fig.cap: "Sammenheng mellom treningalder og myonuclei per muskelfiber CSA i Type-II"
...
## Referanser:
 - Machado FA, Nakamura FY, Moraes SM. Influence of regression model and incremental test protocol on the relationship between lactate threshold using the maximal-deviation method and performance in female runners. J Sports Sci. 2012;30(12):1267-74. doi: 10.1080/02640414.2012.702424. Epub 2012 Jul 10. PMID: 22775431.
- McArdle, William D. and Katch, Frank I. and Katch, Victor L., 2014. utgave 8. Exercise Physiology: Nutrition, Energy, and Human Performance. Wolters Kluwer Health
- Spiegelhalter, D.J. 2019. The art of statistics : learning from data. 1 utgave. Pelican
